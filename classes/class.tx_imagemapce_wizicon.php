 ...
 */
    function proc($wizardItems)    {
        ...
        $newWizardItem['common_imagemap'] = array(
            'icon' => t3lib_extMgm::extRelPath('imagemap_ce').'tt_content_imagemap.gif',
 ...
 */
    function includeLocalLang()    {
        $llFile = t3lib_extMgm::extPath('imagemap_ce').'locallang.xml';
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/imagemap_ce/classes/class.tx_imagemapce_wizicon.php'])    {
    include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/imagemap_ce/classes/class.tx_imagemapce_wizicon.php']);
}
